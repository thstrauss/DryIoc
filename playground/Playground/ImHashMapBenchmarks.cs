...
## A bit more gains with handling a special cases

         Method | Count |         Mean |        Error |       StdDev | Ratio | RatioSD | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
--------------- |------ |-------------:|-------------:|-------------:|------:|--------:|------------:|------------:|------------:|--------------------:|
 AddOrUpdate_v2 |     5 |     456.7 ns |     5.060 ns |     4.225 ns |  0.88 |    0.01 |      0.2165 |           - |           - |                1 KB |
    AddOrUpdate |     5 |     521.6 ns |     4.308 ns |     4.030 ns |  1.00 |    0.00 |      0.2337 |           - |           - |             1.08 KB |
 AddOrUpdate_v1 |     5 |     559.0 ns |    10.562 ns |     9.880 ns |  1.07 |    0.02 |      0.2737 |           - |           - |             1.27 KB |
                |       |              |              |              |       |         |             |             |             |                     |
 AddOrUpdate_v1 |    40 |   5,396.2 ns |    83.931 ns |    78.509 ns |  0.86 |    0.03 |      2.9678 |           - |           - |            13.69 KB |
 AddOrUpdate_v2 |    40 |   5,461.2 ns |    91.939 ns |    81.501 ns |  0.87 |    0.02 |      2.8458 |           - |           - |            13.14 KB |
    AddOrUpdate |    40 |   6,260.9 ns |   118.672 ns |   126.977 ns |  1.00 |    0.00 |      2.6093 |           - |           - |            12.05 KB |
                |       |              |              |              |       |         |             |             |             |                     |
 AddOrUpdate_v1 |   200 |  38,853.6 ns |   527.072 ns |   493.023 ns |  0.87 |    0.02 |     18.7378 |      0.0610 |           - |            86.53 KB |
 AddOrUpdate_v2 |   200 |  41,183.3 ns |   770.324 ns |   682.872 ns |  0.92 |    0.03 |     19.2261 |           - |           - |            88.88 KB |
    AddOrUpdate |   200 |  44,888.3 ns |   845.264 ns |   790.661 ns |  1.00 |    0.00 |     16.7847 |      0.0610 |           - |            77.51 KB |
                |       |              |              |              |       |         |             |             |             |                     |
 AddOrUpdate_v2 |  1000 | 325,113.8 ns | 6,208.625 ns | 7,390.927 ns |  0.92 |    0.02 |    130.8594 |      0.9766 |           - |           604.55 KB |
 AddOrUpdate_v1 |  1000 | 341,349.6 ns | 6,796.044 ns | 6,357.024 ns |  0.97 |    0.02 |    120.6055 |      3.4180 |           - |           556.41 KB |
    AddOrUpdate |  1000 | 350,574.6 ns | 2,275.126 ns | 1,899.834 ns |  1.00 |    0.00 |    109.8633 |      0.4883 |           - |           507.57 KB |
*/
