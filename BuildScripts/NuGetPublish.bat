...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.12.6.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.12.6.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.12.6.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.2.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.2.0.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
