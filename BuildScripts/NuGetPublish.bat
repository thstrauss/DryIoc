...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.12.7.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.12.7.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.12.7.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
