...
rem DryIoc
%NUGET% push "%PACKAGEDIR%\DryIoc.dll.2.12.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.2.12.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
%NUGET% push "%PACKAGEDIR%\DryIoc.Internal.2.12.5.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
...
rem %NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.3.1.3.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
rem %NUGET% push "%PACKAGEDIR%\DryIoc.MefAttributedModel.dll.3.1.3.nupkg" -Source https://nuget.org -ApiKey %APIKEY%
